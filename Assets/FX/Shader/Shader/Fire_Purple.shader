...
Shader "Fx_Alter_CoreSmoke"
{
	...
	SubShader
	{
		...
		{
			Gradient gradient31 = NewGradient( 0, 5, 2, float4( 0.6, 0.7014414, 1, 0 ), float4( 0, 0.1761494, 1, 0.06471352 ), float4( 0, 0.8857895, 0.9019608, 0.40589 ), float4( 0, 0.3771887, 0.4352941, 0.520592 ), float4( 0, 0, 0, 0.997055 ), 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
...
/*ASEBEGIN
Version=18301
7;161;1906;814;1381.008;-527.9844;1;True;False
...
Node;AmplifyShaderEditor.GradientNode;31;-914.4811,663.5959;Inherit;False;0;5;2;0.6,0.7014414,1,0;0,0.1761494,1,0.06471352;0,0.8857895,0.9019608,0.40589;0,0.3771887,0.4352941,0.520592;0,0,0,0.997055;1,0;1,1;0;1;OBJECT;0
...
ASEEND*/
//CHKSM=61DF3F7A46C7A7E0F93F633272BC47BB8F656518