...
namespace YS
{
    public abstract partial class Unit
    {
        ...
        {
            private class SRangeDA1 : SoulCardEffect
            {
                private readonly List<float> physxCoefs;
                private readonly List<float> atkSpdCoefs;

                public SRangeDA1(SRangeDA1Data data, PlayableUnit skillOwner) : base(data, skillOwner)
                {
            ...
            [System.Serializable]
            private class SRangeDA1Data : SoulCardEffectData
            {
                [BoxGroup("앨리스 기본 공격 I", true, true)]
                ...
                {
                    return new SRangeDA1(this, owner as PlayableUnit);
                }
