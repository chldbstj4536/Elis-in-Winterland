...
namespace YS
{
    public abstract partial class Unit
    {
        ...
        {
            private class SMeleeDA2Hidden : SoulCardEffect
            {
                private readonly List<float> dmgRatioDA;
                private readonly SphereHitcast hitbox;
                private int totalDmg;

                public SMeleeDA2Hidden(SMeleeDA2HiddenData data, PlayableUnit skillOwner) : base(data, skillOwner)
                {
            ...
            [System.Serializable]
            private class SMeleeDA2HiddenData : SoulCardEffectData
            {
                [BoxGroup("근거리 기본 공격 II - 히든", true, true)]
                ...
                [BoxGroup("근거리 기본 공격 II - 히든/피해 범위")]
                [HideLabel]
                public SphereHitcast hitbox = new SphereHitcast();

                public SMeleeDA2HiddenData()
                {
#if UNITY_EDITOR
                    ShowPPSetting = false;
                ...
                {
                    return new SMeleeDA2Hidden(this, owner as PlayableUnit);
                }
